...
- **Balance poll interval: 30s (updated 2026-04-13).** `IdentityBar.fetchLiveBalance` polls WoC `/address/{addr}/unspent` every 30 seconds (was 15s). Halves the background WoC request rate to reduce 429 pressure from normal page sitting.
